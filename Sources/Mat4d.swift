...
public struct Mat4d {
	var v00, v01, v02, v03,
		v10, v11, v12, v13,
		v20, v21, v22, v23,
		v30, v31, v32, v33 : Double;

	public static func copy(_ out: inout Mat4d, _ a: inout Mat4d) {
	...
	public static func identity(_ out: inout Mat4d) {
	...
	// out = transpose(a)
	public static func transpose(_ out: inout Mat4d, _ a: inout Mat4d) {
        out.v00 = a.v00
        out.v01 = a.v10
        out.v02 = a.v20
        out.v03 = a.v30
	...
	public static func invert(_ out: inout Mat4d) -> Bool {
	...
	public static func invert(_ out: inout Mat4d, _ a: inout Mat4d) -> Bool {
	...
	public static func adjoint(_ out: inout Mat4d) {
		let tmp = out
	...
	public static func adjoint(_ out: inout Mat4d, _ a: inout Mat4d) {
	...
	public static func mul(_ out: inout Mat4d, _ a: inout Mat4d, _ b: inout Mat4d) {
	...
	public static func translate(_ out: inout Mat4d, _ v: inout Vec3d) {
	...
	public static func translate(_ out: inout Mat4d, _ a: inout Mat4d, _ v: inout Vec3d) {
		out.v00 = a.v00; out.v01 = a.v01; out.v02 = a.v02; out.v03 = a.v03
		out.v10 = a.v10; out.v11 = a.v11; out.v12 = a.v12; out.v13 = a.v13
		out.v20 = a.v20; out.v21 = a.v21; out.v22 = a.v22; out.v23 = a.v23
	...
	public static func rotate(_ out: inout Mat4d, angle: Double, axis: inout Vec3d) -> Bool {
		var len = sqrt(axis.x*axis.x + axis.y*axis.y + axis.z*axis.z)
	...
	public static func rotate(_ out: inout Mat4d, _ a: inout Mat4d, angle: Double, axis: inout Vec3d) -> Bool {
		var len = sqrt(axis.x*axis.x + axis.y*axis.y + axis.z*axis.z)
	...
	public static func rotateX(_ out: inout Mat4d, angle: Double) {
	...
	public static func rotateX(_ out: inout Mat4d, _ a: inout Mat4d, angle: Double) {
		let s = sin(angle), c = cos(angle)
	...
	public static func rotateY(_ out: inout Mat4d, angle: Double) {
		let s = sin(angle), c = cos(angle)
		let a00 = out.v00, a01 = out.v01, a02 = out.v02, a03 = out.v03,
			a20 = out.v20, a21 = out.v21, a22 = out.v22, a23 = out.v23
	...
	public static func rotateY(_ out: inout Mat4d, _ a: inout Mat4d, angle: Double) {
		let s = sin(angle), c = cos(angle)
	...
	public static func rotateZ(_ out: inout Mat4d, angle: Double) {
		let s = sin(angle), c = cos(angle)
		let a00 = out.v00, a01 = out.v01, a02 = out.v02, a03 = out.v03,
			a10 = out.v10, a11 = out.v11, a12 = out.v12, a13 = out.v13
	...
	public static func rotateZ(_ out: inout Mat4d, _ a: inout Mat4d, angle: Double) {
		let s = sin(angle), c = cos(angle)
	...
	public static func scale(_ out: inout Mat4d, _ v: inout Vec3d) {
		out.v00 = out.v00 * v.x
		out.v01 = out.v01 * v.x
		out.v02 = out.v02 * v.x
		out.v03 = out.v03 * v.x
	...
	public static func scale(_ out: inout Mat4d, _ a: inout Mat4d, _ v: inout Vec3d) {
		out.v00 = a.v00 * v.x
		out.v01 = a.v01 * v.x
		out.v02 = a.v02 * v.x
		out.v03 = a.v03 * v.x
	...
	public static func fromTranslation(_ out: inout Mat4d, _ v: inout Vec3d) {
		out.v00 = 1;
		out.v01 = 0;
		out.v02 = 0;
		out.v03 = 0;
	...
	public static func fromScaling(_ out: inout Mat4d, _ v: inout Vec3d) {
		out.v00 = v.x;
	    out.v01 = 0;
	    out.v02 = 0;
	    out.v03 = 0;
	...
	public static func fromRotation(_ out: inout Mat4d, angle: Double, axis: inout Vec3d) {
		var len = sqrt(axis.x*axis.x + axis.y*axis.y + axis.z*axis.z)
	...
	public static func fromXRotation(_ out: inout Mat4d, angle: Double) {
		let s = sin(angle), c = cos(angle)
		out.v00 = 1;
		out.v01 = 0;
		out.v02 = 0;
	...
	public static func fromYRotation(_ out: inout Mat4d, angle: Double) {
		let s = sin(angle), c = cos(angle)
		out.v00 = c;
	    out.v01 = 0;
	    out.v02 = -s;
	...
	public static func fromZRotation(_ out: inout Mat4d, angle: Double) {
		let s = sin(angle), c = cos(angle)
		out.v00 = c;
	    out.v01 = s;
	    out.v02 = 0;
	...
	public static func frustum(_ out: inout Mat4d, left: Double, right: Double, bottom: Double, top: Double, near: Double, far: Double) {
		let rl = 1 / (right - left)
		let tb = 1 / (top - bottom)
		let nf = 1 / (near - far)
		out.v00 = (near * 2) * rl;
	...
	public static func perspective(_ out: inout Mat4d, fovy: Double, aspect: Double, near: Double, far: Double) {
	...
	public static func ortho(_ out: inout Mat4d, left: Double, right: Double, bottom: Double, top: Double, near: Double, far: Double) {
	...
	public static func lookAt(_ out: inout Mat4d, eye: inout Vec3d, center: inout Vec3d, up: inout Vec3d) {
		var x0, x1, x2, y0, y1, y2, z0, z1, z2, len : Double
	...
	public static func add(_ out: inout Mat4d, _ a: inout Mat4d, _ b: inout Mat4d) {
		out.v00 = a.v00 + b.v00
		out.v01 = a.v01 + b.v01
		out.v02 = a.v02 + b.v02
		out.v03 = a.v03 + b.v03
	...
	public static func sub(_ out: inout Mat4d, _ a: inout Mat4d, _ b: inout Mat4d) {
		out.v00 = a.v00 - b.v00
		out.v01 = a.v01 - b.v01
		out.v02 = a.v02 - b.v02
		out.v03 = a.v03 - b.v03
	...
	public static func mul(_ out: inout Mat4d, _ a: inout Mat4d, _ b: Double) {
		out.v00 = a.v00 * b
		out.v01 = a.v01 * b
		out.v02 = a.v02 * b
		out.v03 = a.v03 * b
	...
	public static func mac(_ out: inout Mat4d, _ a: inout Mat4d, _ scale: Double) {
	...
	public static func mac(_ out: inout Mat4d, _ a: inout Mat4d, _ b: inout Mat4d, _ scale: Double) {
	...
	public static func exactEquals(_ a: inout Mat4d, _ b: inout Mat4d) -> Bool {
		return a.v00 == b.v00
			&& a.v01 == b.v01
			&& a.v02 == b.v02
			&& a.v03 == b.v03
	...
	public static func equals(_ a: inout Mat4d, _ b: inout Mat4d, epsilon: Double) -> Bool {
	...
	private static func max3(_ a: Double, _ b: Double, _ c: Double) -> Double {
